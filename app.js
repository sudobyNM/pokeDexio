...
pokemonGrid.addEventListener("click", (e) => {
  if (e.target.classList.contains("type-label")) {
    ...
    if (typesName.length > 0) {
      ...
      pokemonGrid.innerHTML = '<p class="error">No Pokemon found of this type.</p>';
    }
  }
});
                    ...
                    <div class="modal-body">
                        <div class="flex">
                            ...
                            <div class="body-stats">
                                <p>height: <span class="h">${pokemon.height /10} m</span></p>
                                <p>weight: <span class="h">${pokemon.weight /10} kg </span></p>
                            </div>
                            ...
                            <div class="poke-category">
                                ...
                                ${pokeChain.map(({chain}) => {
                                    ...
                                    const first = chain.evolves_to[0]?.species.name;
                                    const second = chain.evolves_to[0]?.evolves_to[0]?.species.name;
                                    
                                    return `<div class="evolution-chain">
                                        ${base}
                                        ${first ? ` ---> ${first}` : ' (No evolution)'}
                                        ${second ? ` ---> ${second}` : ''}
                                    </div>`;
                                }).join('')}
                            </div>
                        ...
                        <div class="info-container">
                            ...
                            <div class="ability">
                                ...
                                ${pokemon.abilities.map((ability) => `
                                    <p class="${ability.is_hidden ? 'hidden-ability' : ''}">
                            ...
                            <div><h4 class="gen">Generation ${Math.ceil(pokemon.id / 151)}</h4>
                            </div>
                        </div>
                    </div>
